...
#include <mongocxx/apm/private/command_failed_event.hh>
...
bsoncxx::document::view command_failed_event::failure() const {
    auto failure = mongoc_apm_command_failed_get_reply(_impl->failed_event_t);
    return {bson_get_data(failure), failure->len};
}

bsoncxx::stdx::string_view command_failed_event::command_name() const {
    return mongoc_apm_command_failed_get_command_name(_impl->failed_event_t);
}

std::int64_t command_failed_event::duration() const {
    return mongoc_apm_command_failed_get_duration(_impl->failed_event_t);
}

std::int64_t command_failed_event::request_id() const {
    return mongoc_apm_command_failed_get_request_id(_impl->failed_event_t);
}

std::int64_t command_failed_event::operation_id() const {
    return mongoc_apm_command_failed_get_operation_id(_impl->failed_event_t);
}

bsoncxx::stdx::string_view command_failed_event::host() const {
    return mongoc_apm_command_failed_get_host(_impl->failed_event_t)->host;
}

std::uint16_t command_failed_event::port() const {
    return mongoc_apm_command_failed_get_host(_impl->failed_event_t)->port;
}
